...
#         It sets the initial amount of cash in the portfolio
#         to be equal to the input initial_cash parameter.
#
...
#         with the attributes (prices, units, initial_cash, trading_cost_model)
#         as specified in the Portfolio builder.
#
...
#         The resulting EquityPortfolio object will have the same state as the
#         Portfolio builder from which it was built.
#         """
#
